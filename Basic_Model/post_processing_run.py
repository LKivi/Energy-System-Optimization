...
def read_solution_file(file_name, time_series_list, time_steps):
    ...
    return time_series_flows, other_dec_var
...
#                 "power_WT", "power_PV", "heat_STC", 
    ...
    for folder in folder_list:
        if "pareto" in folder:
            ...
            time_series_flows, other_dec_var = read_solution_file(dir_results + "\\" + folder + "\\model.sol", tech_list, number_steps)
...
if __name__ == "__main__":
    ...
    dir_results = "C:\\Users\lkivi\Desktop\Test"
